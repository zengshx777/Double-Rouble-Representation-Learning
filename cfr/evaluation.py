...
def evaluate_cont_ate(predictions, data, i_exp, I_subset=None,
    ...
    # '''ATE for EB'''
    # if FLAGS.eb_enable==1 and FLAGS.eb_target=="ATE":
    #     residual = yf-yf_p;
    #     residual [t<1] = -residual [t<1];
    #     ate_pred=np.mean(eff_pred)+np.average(residual, weights = eb_weights)
